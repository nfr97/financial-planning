...
import {
  getStatistics as computeStatistics,
  getHistogramData as computeHistogramData,
} from './statistics.js';
...
export class RetirementSimulator {
   ...
   */
  getStatistics() {
    return computeStatistics(this.allEndingBalances);
  }
  ...
  getHistogramData(numBins = 15) {
    return computeHistogramData(this.allEndingBalances, numBins, this._formatCurrency);
  }
